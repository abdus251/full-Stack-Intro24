...
const Footer = () => {
  return (
    ...
    <Typography color="#fff" component={Link} href="/consultation">Consultation
    </Typography>

    <Typography color="#fff" component={Link} href="/healthplan">Health Plans
    </Typography>
...
<Stack direction="row" gap={2} justifyContent="space-between" alignItems="center" py={3}>
    <Typography component='p' color="white">
        &copy;2024 Ph HealtCare. All Rights Reserved.
    </Typography>
    <Typography 
    variant="h4" 
    component={Link} 
